    ...
    if request.method == 'POST':
        ...
        if user_answer == bot_action:
            ...
            if bot_action == "scissors":
                messages.info(request,"Choosen: Rock Computer: Scissors.. You win!")
                return redirect('Game')
            ...
            if bot_action == "rock":
                ...
                messages.info(request,"Choosen: Paper Computer: Rock.. You win!")
                return redirect('Game')
            ...
            if bot_action == "paper":
                ...
                messages.info(request,"Choosen: Scissor Computer: Paper.. You win!")
                return redirect('Game')
